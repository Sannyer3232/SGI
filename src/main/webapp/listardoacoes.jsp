...
<title>SGI - Lista de Doações</title>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="selectdoacao?iddoacao=<%= lista.get(i).getIddoacao() %>">
										<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
									</a>
								</td>
								<td>
									<button onclick="abrirModalAlertaDoacoes('<%= lista.get(i).getIddoacao() %>')">
										<i class="fa fa-trash-o" aria-hidden="true"></i>
									</button>
								</td>
								<td>
									<a href="reportdoacao?iddoacao=<%= lista.get(i).getIddoacao() %>">
