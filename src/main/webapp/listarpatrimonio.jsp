...
<title>SGI - Lista de Patrimônios</title>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="selectpatri?idpatrimonio=<%= lista.get(i).getIdpatrimonio() %>">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </a>
                                </td>
                                <td>
                                    <button onclick="abrirModalAlertaPatrimonio(<%= lista.get(i).getIdpatrimonio() %>)">
