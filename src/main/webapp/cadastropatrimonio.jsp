...
<html lang="pt-br">
<head>
<title>Cadastro Património</title>
<meta charset="UTF-8">
<meta name="viewport"
...
<body>
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li><a href="#!" class="btn-sideBar-SubMenu"> <i
					...
					<ul class="list-unstyled full-box">
						<li><a href="cadastrocontas.html"><i
								class="zmdi zmdi-exposure-alt zmdi-hc-fw"></i> Contas</a></li>
						<li><a href="cadastrodoacoes.html"><i
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Área reservada ao cadastro de Patrimonio e
				visualização dos patrimonios da Igreja</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
						<li class="active"><a href="#new" data-toggle="tab">
								Novo Patrimonio</a></li>
						<li><a href="pesquisarpatri.jsp">Lista de Patrimonios</a></li>
					</ul>
										...
										<form name="frmPatrimonio" action="insertpatri" method="get">
											...
											<div class="form-group label-floating">
												<label class="control-label">Data de Aquisição</label> <input
													class="form_group" type="date" name="ptrdataaquisicao" required>
											</div>
