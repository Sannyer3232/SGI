...
<title>SGI - Edição de Tarefas</title>
	...
	<div class="home-container">
		...
		<div class="formularios-container" id="form-normal">
			<div class="forms">
				...
				<form method="get" name="frmMembro" action="updateTarefa"
					onsubmit="return validarCadastroTarefa()">
					<div class="form">
						<div class="input-box">
							<label>Tarefa ID</label> <input value="<%=tarefa.getTarefaid()%>"
								readonly class="form-control" type="text" name="trfid">
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							<label>Descrição</label> <input
								...
								type="text" name="trfdesc" required>
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							<label>Data de Agendamento</label> <input class="form_group"
								type="date" id="trfdata" name="trfdata"
						...
						<div class="input-box">
							<label>Hora de Agendamento</label> <input class="form_group"
								...
								value="<%=tarefa.getTarefahora()%>" required>
						</div>
						<div class="input-box">
							<label>Status</label>
							<div class="select-box-ig">
