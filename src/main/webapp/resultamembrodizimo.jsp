...
<title>SGI - Lista de Membros para Dízimo</title>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="cadastroDizimo.jsp?mbrNome=<%= listaMembros.get(i).getMbrmemnome() %>&mbrID=<%= listaMembros.get(i).getId_Membro() %>">
