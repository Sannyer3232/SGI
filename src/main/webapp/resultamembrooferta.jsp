...
<% ArrayList<MembroJavaBeans> membros = (ArrayList<MembroJavaBeans>) request.getAttribute("pesquisaMembros"); %>
 

<!DOCTYPE html>
<html lang="es">
<head>
<title>Resultado da Pesquisa de Membros</title>
<meta charset="UTF-8">
<meta name="viewport"
												...
												<table class="table table-hover text-center">
													<thead>
														<tr>
															...
															<th class="text-center">Cadastar Dizimo</th>
													...
													<tbody>
														...
														<tr>
															...
															<td><a href = "cadastroOferta.jsp?mbrNome=<%=listaMembros.get(i).getMbrmemnome()%>&mbrID=<%=listaMembros.get(i).getId_Membro()%>"
