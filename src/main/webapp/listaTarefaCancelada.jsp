		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles">
					<i class="zmdi zmdi-assignment"></i> Tarefas <small>Canceladas</small>
				</h1>
			</div>
												...
												<table class="table table-hover text-center" id="tabela" >
													...
													<tbody>
														...
														for (int i = 0; i < lista.size(); i++) {
															...
															LocalDateTime tarefaDataHora = LocalDateTime.parse(lista.get(i).getTarefadata() + " " + lista.get(i).getTarefahora(),
															DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
															DateTimeFormatter sdf = DateTimeFormatter.ofPattern("dd/MM/yyyy");
															DateTimeFormatter shf = DateTimeFormatter.ofPattern("HH:mm");
															String dataFormatada = tarefaDataHora.format(sdf);
															String horaFormatada = tarefaDataHora.format(shf);
														...
														<tr id="linhaCancelada">
															...
															<td><a
																...
																class="btn btn-success btn-raised btn-xs"><%=lista.get(i).getStatus()%> <i
