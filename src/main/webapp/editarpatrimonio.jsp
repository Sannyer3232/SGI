...
<title>SGI - Edição de Patrimônios</title>
...
<body>
	...
	<div class="home-container">
		...
		<div class="formularios-container" id="form-normal">
            <div class="forms">
                <div class="form-title">
                    <h2>Atualização de Patrimônio</h2>
                </div>
                <form name="frmPatrimonio" action="updatepatri" method="get">
                    <div class="form">
                        <div class="input-box">
                            <label>Id</label>
                            <input class="form-control" type="text" name="idpatrimonio" readonly
                                value="<%out.print(request.getAttribute("idpatrimonio"));%>">
                        </div>
                        <div class="input-box">
                            <label>Nome do Item</label>
                            <input class="form-control" type="text" name="ptrnome"
                                value="<%out.print(request.getAttribute("ptrnome"));%>" required>
                        </div>
                        <div class="input-box">
                            <label>Filial</label>
                            <div class="select-box-ig">
                                <select class="form_group" name="ptridfil" required>
                        ...
                        <div class="input-box">
                            ...
                            <input class="form-control" type="text" name="ptrdescricao"
                                value="<%out.print(request.getAttribute("ptrdescricao"));%>" required>
                        </div>
                        <div class="input-box">
                            <label>Valor</label>
                            <input class="form-control" type="text" name="ptrvalor"
                                value="<%out.print(request.getAttribute("ptrvalor"));%>" required>
                        </div>
                        <div class="input-box">
                            <label>Data de Aquisição</label>
                            <input class="form_group" type="date" name="ptrdataaquisicao"
                                value="<%out.print(request.getAttribute("ptrdataaquisicao"));%>" required>
                        </div>
                        <div class="input-box">
                            <label>Estado</label>
                            <div class="select-box-ig">
        ...
        <div class="submit">
            <button type="submit" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Salvar</button>
        </div>
        </form>
