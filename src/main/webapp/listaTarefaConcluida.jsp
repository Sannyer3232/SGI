		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles">
					<i class="zmdi zmdi-assignment"></i> Tarefas <small>Conluídas</small>
				</h1>
			</div>
													...
													<table class="table table-hover text-center" id="tabela">
														...
														<tbody>
															...
															for (int i = 0; i < lista.size(); i++) {
																...
																LocalDateTime tarefaDataHora = LocalDateTime.parse(
																lista.get(i).getTarefadata() + " " + lista.get(i).getTarefahora(),
