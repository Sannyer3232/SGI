...
<link rel="stylesheet" href="./css/bota_ajudas.css">
<link rel="stylesheet" href="./css/janela-modal-video.css">
...
<body>
		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles">
					<i class="zmdi zmdi-pin-help"></i> Ajuda <small></small>
				</h1>
                <p class="lead">Área reservada a ajuda. Escolha um módulo e assiste o vídeo de ajuda</p>
					...
					<div id="myTabContent" class="tab-content">
						...
						<div class="tab-pane fade active in" id="new">
							<div class="container-fluid">
								...
								<div class="row" id = "botoes-ajuda">
                                
                                <div class="button-container">
                                <p class="lead">Ajuda com módulo de membros:</p>
                                    <a  href = "exibirajuda.jsp?nomevideo=1"class="cssbuttons-io-button">
                                        Assista ao vídeo sobre  membros!
                                        <div  class="icon">
                                          <svg 
                                            height="24"
                                            width="24"
                                      ...
                                      <p class="lead">Ajuda com módulo de Tarefas:</p>
                                      <a href = "exibirajuda.jsp?nomevideo=2"class="cssbuttons-io-button">
                                        Assista ao vídeo sobre tarefas!
                                        <div class="icon">
                                          <svg
                                            height="24"
                                            width="24"
                                      ...
                                      <p class="lead">Ajuda com módulo de contas a pagar:</p>
                                      <a  href = "exibirajuda.jsp?nomevideo=3" class="cssbuttons-io-button">
                                        Assista ao vídeo sobre contas!
                                        <div class="icon">
                                          <svg
                                            height="24"
                                            width="24"
                                      ...
                                      <p class="lead">Ajuda com módulo de Patrimônio:</p>
                                      <a href = "exibirajuda.jsp?nomevideo=4" class="cssbuttons-io-button">
                                        Assista ao vídeo sobre os patrimônio!
                                        <div class="icon">
                                          <svg
                                            height="24"
                                            width="24"
    ...
    <script src="./js/abrir-modal-video.js"></script>
