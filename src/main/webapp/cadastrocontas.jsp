...
<title>SGI - Cadastro de Contas</title>
					...
					<div class="form">
						...
						<div class="input-box">
							<label>Descrição da conta</label> <input class="form-control"
								type="text" name="descricao" placeholder="Descrição da conta"
								required>
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							...
							<div class="select-box-ig">
								<select class="form_group" name="status" required>
...
<div class="janela-modal-sucesso" id="janela-modal-sucesso">
	<div class="modal-sucesso">
		...
		<div class="container-modal">
			...
			<h1>Sucesso!</h1>
			<p>O cadastro do evento foi realizado com sucesso.</p>
		</div>
	</div>
</div>
<%
...
<div class="janela-modal-erro" id="janela-modal-erro">
	<div class="modal-erro">
		...
		<div class="container-modal">
			...
			<h1>Erro!</h1>
			<p>Erro ao cadastrar o evento.</p>
		</div>
	</div>
</div>
<%
