		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles">
					<i class="zmdi zmdi-money-box"></i> Ofertas <small>Cadastro</small>
				</h1>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					...
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
						...
						<li><a id="fonte-nav" href="membroparaoferta.jsp"> Nova
								pesquisa</a></li>
						<li class="active"><a id="fonte-nav"
							href="consultaOferta.jsp">Consultar Registro de Oferta</a></li>
					</ul>
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form method="get" name="frmOferta" action="insertOferta">
											...
											<input type="hidden" value="Oferta" name="dzotipo">
											...
											<div class="form-group label-floating">
												<label class="control-label">Data da Contribuição</label> <input
													class="form_group" type="date" id="trfdata"
													name="dzodtcontribuicao" required>
											</div>

											<p class="text-center">
												<button type="submit" onclick="abrirModal()"
													class="btn btn-info btn-raised btn-sm">
													<i class="zmdi zmdi-floppy"></i> Salvar
												</button>
											</p>
										</form>
									</div>
...
<div class="janela-modal-sucesso" id="janela-modal-sucesso">
	<div class="modal-sucesso">
		...
		<div class="container-modal">
			...
			<h1>Sucesso!</h1>
			<p>O cadastro da oferta foi realizada com sucesso.</p>
		</div>
	</div>
...
<div class="janela-modal-erro" id="janela-modal-erro">
	<div class="modal-erro">
		...
		<div class="container-modal">
			<img class="icone" alt="erroIcon" src="./assets/img/erro.png">
			<h1>Erro!</h1>
